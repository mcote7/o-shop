...
export class NutritionService {
  ...
  getNutritionFacts(item: string): Observable<any> {
    return this.http.get(`https://api.edamam.com/api/nutrition-data?app_id=457c1396&app_key=df29b42c10b99b78f454a3a7f4ae3cae&nutrition-type=logging&ingr=${item}`)
